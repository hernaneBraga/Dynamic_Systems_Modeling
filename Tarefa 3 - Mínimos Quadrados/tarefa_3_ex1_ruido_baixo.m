...
xlabel('Tempo (s)');
ylabel('Amplitude');
title('Resposta do sistema - baixo ruído');
...
xlabel('Tempo (s)')
ylabel('Amplitude');
title('Entrada PRBS - baixo ruído');
ylim([-1.5 2.0])
...
d = 18; %Atraso estimado via FCC. No tempo: atraso = 18*Ts -> 54s de atraso 
...
plot(t2, y_modelo, 'm--');
legend('G(s)','Modelo');
title('G(s) x Modelo encontrado - Entrada PRBS com baixo ruído');
xlabel('Tempo (s)');
ylabel('Amplitude');
...
step(G_modelo, 'm--')
legend('G(s)','Modelo');
title('G(s) x Modelo encontrado - Resposta ao impulso com baixo ruído');
xlabel('Tempo (s)');
ylabel('Amplitude');
